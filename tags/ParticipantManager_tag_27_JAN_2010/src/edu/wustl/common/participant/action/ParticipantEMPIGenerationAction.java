...
public class ParticipantEMPIGenerationAction extends CommonAddEditAction {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		try {
			...
			if (isGenerateHL7.equalsIgnoreCase(Constants.YES)) {
				...
				String eMPIStatus = ParticipantManagerUtility
	 ...
	 */
	private void registerPatientToEMPI(HttpServletRequest request,
			IParticipantForm participantForm) throws BizLogicException, AssignDataException {
	...
	private void setStatusMessage(HttpServletRequest request, String regStatus) {
		...
		if (regStatus.equals(edu.wustl.common.util.global.Constants.SUCCESS)) {
			...
			ActionErrors actionErrors = (ActionErrors) request
	 ...
	 *             the DAO exception
	 */
	private void generateEMPI(HttpServletRequest request,
			IParticipantForm participantForm) throws DAOException {
