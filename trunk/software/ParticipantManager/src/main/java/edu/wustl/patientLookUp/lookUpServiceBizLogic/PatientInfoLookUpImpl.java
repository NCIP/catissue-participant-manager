...
public class PatientInfoLookUpImpl implements IPatientLookUp
{
	 ...
	 * @throws edu.wustl.patientLookUp.util.PatientLookupException :PatientLookupException
	 */
	...
	/* (non-Javadoc)
	 * @see IPatientLookUp#searchMatchingParticipant
	 * (PatientInformation, int, int)
	 */
	...
	/* (non-Javadoc)
	 * @see edu.wustl.patientLookUp.lookUpServiceBizLogic.IPatientLookUp#setQueryExecutor(IQueryExecutor)
	 */
