...
import wustl.patientLookUp.util.PatientLookUpFactory;
import wustl.patientLookUp.util.PatientLookupException;
import wustl.patientLookUp.util.PropertyHandler;
...
public class PatientInfoLookUpService
{
	 ...
	 * @throws wustl.patientLookUp.util.PatientLookupException throws PatientLookupException
	 */
