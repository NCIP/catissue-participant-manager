package wustl.patientLookUp.util;
 ...
 *
 * @author geeta_jaggal
 * This class will define the constant values.
 */
public class Constants
{
	...
	/** The EMP i_ d b_ schema. */
	public static String EMPI_DB_SCHEMA = "empiDBSchema";
	...
	/** The Constant ACTIVITY_STATUS_DISABLED. */
