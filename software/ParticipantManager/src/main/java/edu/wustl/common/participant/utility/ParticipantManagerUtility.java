package wustl.common.participant.utility;
...
import wustl.common.participant.client.IParticipantManager;
import wustl.common.participant.client.IParticipantManagerLookupLogic;
import wustl.common.participant.domain.*;
...
//			participantInfo.add(participant.getEmpiId());
	...
	{
		String PartiManagerImplClassName = (String) PropertyHandler
