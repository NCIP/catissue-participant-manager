package wustl.patientLookUp.queryExecutor;
...
import wustl.patientLookUp.util.Logger;
...
public class SQLQueryExecutorImpl extends AbstractQueryExecutor
{
	 ...
	 * @throws wustl.patientLookUp.util.PatientLookupException :PatientLookupException
	 */
