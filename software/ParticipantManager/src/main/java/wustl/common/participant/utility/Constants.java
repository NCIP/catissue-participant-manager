...
public class Constants
{
	...
	/** The Constant CATISSUE_ADMIN_LOGIN_ID. */
	public static final String CATISSUE_ADMIN_LOGIN_ID = "catissueAdminLoginId";

	/** The Constant ACTIVITY_STATUS_CLOSED. */
	...
	/** The Constant SPREADSHEET_DATA_LIST. */
	...
	/** The Constant PARTICIPANT_LOOKUP_ALGO_EMPI. */
	public static final String PARTICIPANT_LOOKUP_ALGO_EMPI = "ParticipantLookupAlgoEMPI";
